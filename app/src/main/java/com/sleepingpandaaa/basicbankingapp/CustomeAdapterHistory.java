...
public class CustomeAdapterHistory extends RecyclerView.Adapter<ViewHolder> {
    ...
    com.sleepingpandaaa.basicbankingapp.HistoryList HistoryList;
    List<Model> modelList;
    Context context;

    TextView mTransc_status;

    public CustomeAdapterHistory(com.sleepingpandaaa.basicbankingapp.HistoryList historyList, List<Model> modelList) {
