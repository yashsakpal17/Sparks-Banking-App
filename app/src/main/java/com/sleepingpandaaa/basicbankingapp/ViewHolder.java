...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.sleepingpandaaa.basicbankingapp.ViewHolder.ClickListener mClickListener;
    public interface  ClickListener{
        void onItemClick(View view, int position);
    }

    public void setOnClickListener(com.sleepingpandaaa.basicbankingapp.ViewHolder.ClickListener clickListener){
